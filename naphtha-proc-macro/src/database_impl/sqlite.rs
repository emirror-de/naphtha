...
fn impl_database_modifier(
    ...
    quote! {
            ...
            + ::naphtha::DatabaseRemoveHandler<::naphtha::diesel::SqliteConnection>,
        {
            ...
            fn update(&mut self, conn: &::naphtha::DatabaseConnection<::naphtha::diesel::SqliteConnection>) -> ::anyhow::Result<()> {
            ...
            fn remove(&mut self, conn: &::naphtha::DatabaseConnection<::naphtha::diesel::SqliteConnection>) -> ::anyhow::Result<()> {
                use {
